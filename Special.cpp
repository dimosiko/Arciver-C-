...
char *ReadStr(void)
{
	...
	while (true)
	{
		...
		if (str[0] == '\0')
		{
			printf("Ââåäåíà ïóñòàÿ ñòðîêà. Ïîæàëóéñòà, ââåäèòå äðóãîå èìÿ\n");
			size = 256;
			free(str);
		}
		else
		{
			for (i = 0; i < strlen(str); i++)
			{
				...
				{
					printf("Ââåäåíû íåäîïóñòèìûå ñèìâîëû. Ïîæàëóéñòà, ââåäèòå èìÿ, íå ñîäåðæàùåå ñèìâîëû \\ / : * ? \" < > | \n");
					size = 257;
					free(str);
				}
			}
